...
//project routes
Route::get('add', array('as'=>'add','uses'=>'ProjectController@getAddProject'));
Route::post('add', 'ProjectController@postAddProject');

Route::get('show', array('as'=>'show','uses'=>'ProjectController@getShowProjects'));
...
Route::get('contact-us', array('as' => 'contact-us', 'uses' => 'ProjectController@getAddProject'));
Route::post('contact-us', 'ProjectController@postAddProject');

Route::get('blog/{postSlug}', array('as' => 'view-post', 'uses' => 'BlogController@getView'));
Route::post('blog/{postSlug}', 'BlogController@postView');

Route::get('/', array('as' => 'home', 'uses' => 'ProjectController@getShowProjects'));
